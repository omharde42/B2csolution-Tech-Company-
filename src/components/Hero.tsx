      ...
      <div className="grid items-center gap-12 lg:grid-cols-2">
        ...
        >
          ...
          <h1 className="font-display text-4xl font-black leading-tight tracking-tight md:text-5xl lg:text-6xl mb-6">
            Build It.<br />
            <span className="text-gradient-brand">Scale It.</span><br />
            Launch It.
          </h1>

          <p className="mx-auto max-w-lg text-base text-muted-foreground md:text-lg lg:mx-0 mb-8 leading-relaxed">
            Web development, graphic design, branding & digital solutions — powered by <strong className="text-foreground">B2C Solution</strong>. Affordable tech services with premium quality.
          </p>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
            ...
            >
              <Code size={16} /> Our Services <ArrowRight size={14} />
            </Link>
            <a
              href="https://api.whatsapp.com/send?phone=919882303030&text=Hi%20B2C%20Solution!%20I%27d%20like%20to%20discuss%20a%20project."
              target="_blank"
